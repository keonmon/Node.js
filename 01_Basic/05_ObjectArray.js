...
let oldObject = {
    ...
    sayNode,    // 키(멤버변수)이름과 Value변수명이 같으면 한번만 써도 된다. 
};
...
//위와 같이 한 번에 구조분해를 하기 위해선 중괄호{}안의 변수이름을 맞춰서 분해한다.
// 분해하지 않으려고 하는 멤버는 중괄호안에 쓰지 않아서 분해에서 제외할 수 있다.

// 이는 아래와 같이 배열에 여러 자료를 넣어놓고 인덱스를 이용하여 따로따로 추출하는 것과 한 번에 추출하는 모양과 같은 형식으로 사용한다.
// 하나의 변수에 하나씩 추출
